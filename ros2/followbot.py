...
class FollowBot(Node):
    ...
    #         if t.header.frame_id == '/robot2/odom':
    #             to_frame_rel = t.header.frame_id
            
    #             print("header:" +t.header.frame_id)
    #             print("childid: "+t.child_frame_id)
    #             target_x = t.transform.translation.x
    #             target_y = t.transform.translation.y
    #             try:
    #                 from_frame = robot2_frame.header.frame_id
    #                 framebuffer= [t, robot2_frame]
    #                 trans = framebuffer.lookup_transform(
    #                 to_frame_rel,
    #                 from_frame,
    #                 rclpy.time.Time())
    #                 print(trans)
